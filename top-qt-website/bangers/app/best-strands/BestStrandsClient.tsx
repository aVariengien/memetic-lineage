...
export function BestStrandsClient({ strands, graphData }: BestStrandsClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Strand Map Visualization */}
        {graphData && (
          <div className="mb-8">
            <h2 className="text-lg font-bold mb-3 tracking-tight">Strand Map</h2>
            <StrandGraph graphData={graphData} width={1200} height={600} />
            <p className="mt-2 text-xs text-gray-500 text-center">
              Each dot represents a tweet author in an essential conversation moment. 
              Chains show tweets within the same strand. 
              Strands cluster by semantic similarity.
            </p>
          </div>
        )}
