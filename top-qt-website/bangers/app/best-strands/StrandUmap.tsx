  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative">
        {/* Legend */}
        <div className="absolute top-4 left-4 bg-white border-2 border-black shadow-[4px_4px_0_0_#000] p-4 z-10 max-w-md">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1">
                ...
                <span>Root tweet</span>
              </div>
            </div>
            <div className="pt-1 border-t border-gray-200">
              <div className="flex items-center gap-2 mb-1">
                <div className="w-6 h-px bg-blue-500"></div>
                <span>Temporal connections (chronologically adjacent tweets)</span>
              </div>
              <div className="text-gray-600 text-xs">
                Lines connect tweets posted close in time within the same strand
              </div>
            </div>
            <div className="pt-1 border-t border-gray-200">
              <div className="text-gray-700 font-medium">Strand Titles</div>
              <div className="text-gray-600 text-xs">
                Displayed near root tweets for strands rated 7/10 or above
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Controls */}
        <div className="absolute top-4 right-4 bg-white border-2 border-black shadow-[4px_4px_0_0_#000] p-4 z-10 max-w-xs">
        <div className="space-y-3">
          ...
          <div className="pt-2 border-t border-gray-200">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <div>● Circle: Regular tweet</div>
              <div>▲ Triangle: Root tweet (strand starter)</div>
              <div>■ Square: Tweet with image/media</div>
            </div>
          </div>
          
          {/* Connection Parameters */}
          <div className="pt-2 border-t border-gray-200">
            <div className="text-xs font-semibold text-gray-700 mb-2">Connection Parameters</div>
            
            <div className="mb-3">
              <label className="block text-xs text-gray-600 mb-1">
                Distance Threshold: {connectionThreshold.toFixed(3)}
              </label>
              <input
                type="range"
                min="0.02"
              ...
              <div className="text-xs text-gray-500 mt-1">
                Connects chronologically adjacent tweets if close enough
              </div>
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-gray-200">
            ...
            <div className="text-xs text-gray-600">
              {data.points.length} tweets, {new Set(data.points.map(p => p.strand_id)).size} strands
              {enrichedData.size > 0 && (
                <div className="text-green-600 mt-1">
                  ✓ {enrichedData.size} enriched with real data
                </div>
              )}
              {isLoadingTweetData && (
                <div className="text-blue-600 mt-1 animate-pulse">
                  Loading tweet data...
                </div>
              )}
            </div>
